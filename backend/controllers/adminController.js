...
// // --- Helper to Generate Teacher Username ---
...
//   } catch (error) {
//      if (error.code === 11000) {
//         if (error.keyPattern.username) return next(new AppError('Username generation collision. Please try again.', 400));
//         if (error.keyPattern.email) return next(new AppError('Email already exists.', 400));
//     }
//     next(error);
//   }
// };
